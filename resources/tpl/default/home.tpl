[meta-title][is_home_first]{seo.title}[/is_home_first][not-is_home_first][page.heading]{page.heading} — смотреть онлайн бесплатно[/page.heading][not-page.heading]{seo.title}[/not-page.heading][/not-is_home_first][/meta-title]
    ...
    [is_home_first]
        ...
        [loop home_sections]
            <div class="sect" data-home-section-type="{item.taxonomy_type|raw}" data-home-section-id="{item.taxonomy_id}">
                <div class="sect-header fx-row fx-middle fx-start">
                    <a href="{item.url|raw}" class="sect-title">{item.title}<span class="fa fa-chevron-right"></span></a>
                    [item.show_tabs]
            ...
            [not-popular_list]
                <div class="sect">
                    <div class="sect-cont sect-items clearfix">
                        <p class="desc-text">Пока нет сериалов в каталоге. Добавьте контент через админку или KinoPoisk sync.</p>
                    </div>
                </div>
            [/not-popular_list]
        [/not-home_sections]
