    ...
    <div class="movie-tip__content">
        ...
        [preview.badges]
            <div class="movie-tip__badges">
                [loop preview.badges]
                    [item.mod]
                        <span class="movie-tip__badge movie-tip__badge--{item.mod}">{item.text}</span>
                    [/item.mod]
                    [not-item.mod]
                        <span class="movie-tip__badge">{item.text}</span>
                    [/not-item.mod]
                [/loop]
            </div>
        [/preview.badges]
