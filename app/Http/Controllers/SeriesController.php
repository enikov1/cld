...
class SeriesController extends TplController
{
    ...
    public function show(string $seriesPath): RedirectResponse|Response
    {
        ...
        $seriesData = [
            ...
            'year_start' => $series->yearStart() !== null ? (string)$series->yearStart() : '',
            'year_end' => $series->yearEnd() !== null ? (string)$series->yearEnd() : '',
            'year_full' => $series->yearFull(),
            'duration_minutes' => $series->duration_minutes,
            'duration_label' => $series->durationLabel() ?? '',
            ...
            'finale_date_label' => $series->finaleDateLabel() ?? '',
