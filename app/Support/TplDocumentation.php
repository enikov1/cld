    ...
    private static function contexts(): array
    {
        return [
            ...
            'home' => self::context(
                ...
                ['is_home_first', 'popular_list', 'popular_cards_html', 'new_episodes_list', 'new_episodes_cards_html', 'new_episodes_block', 'has_schedule_calendar', 'schedule_calendar', 'schedule_calendar_json', 'schedule_calendar_block', 'home_sections', 'category_sections', 'promo_collections', 'series_list', 'pagination_block', 'home_seo_html', 'catalog_filters_block', 'filter_fields', 'category_seo_html', 'page.lead', 'item.badge_new_episode', 'item.badge_popular', 'item.season_badge', 'item.episode_badge', 'item.top_reaction_emoji'],
                [
