        ...
        return [
            ...
            'series' => self::context(
                ...
                array_merge(self::globalVariables(), [
                    ...
                    self::docVar('series.year', 'Год (первой серии)'),
                    self::docVar('series.year_start', 'Год старта (первой серии)'),
                    self::docVar('series.year_end', 'Год последней серии, если он больше года старта'),
                    self::docVar('series.year_full', 'Годы в формате 2010-2014 (старт-финал); если годы совпадают — только год старта'),
                    ...
                    self::docVar('series.finale_date_label', 'Дата завершения сериала (если уже закончился)'),
                    self::docVar('series.duration_label', 'Длительность: «4 дня 9 часов 25 минут»'),
                    self::docVar('series.duration_minutes', 'Длительность в минутах (число)'),
                ...
                ['series.description', 'series.year', 'series.year_start', 'series.year_end', 'series.year_full', 'series.year_url', 'series.finale_date_label', 'series.duration_label', 'series.duration_minutes', 'series.studios', 'series.collections', 'series.voices', 'has_player', 'has_players', 'has_reactions', 'has_schedule', 'has_comments', 'has_comments_vote', 'has_series_vote', 'has_notifications', 'has_watchlists', 'has_favourites', 'has_coming_soon', 'has_telegram', 'has_related', 'episodes_modal', 'reactions_widget', 'related_cards_html', 'series_seo_html', 'ad_vpaid_code', 'ad_below_player_code', 'type-1', 'type-2', 'type-3', 'type-4', 'type-5', 'type-6', 'type-7'],
                [
