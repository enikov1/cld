        ...
        return [
            ...
            'series' => self::context(
                ...
                array_merge(self::globalVariables(), [
                    ...
                    self::docVar('series.year_end', 'Год финала (последней серии, если сериал завершён)'),
                    self::docVar('series.year_full', 'Годы в формате 2010-2014 (старт-финал); если финала нет — только год старта'),
