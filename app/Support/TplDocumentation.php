        ...
        return [
            ...
            'catalog' => self::context(
                ...
                array_merge(self::globalVariables(), [
                    ...
                    self::docVar('taxonomy_type', 'Тип таксономии: genre|country|year|person'),
