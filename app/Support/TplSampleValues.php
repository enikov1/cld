    ...
    private static function seriesValues(): array
    {
        ...
        return [
            ...
            'values' => [
                ...
                'series.year_start' => $series->yearStart() !== null ? (string)$series->yearStart() : '',
                'series.year_end' => $series->yearEnd() !== null ? (string)$series->yearEnd() : '',
                'series.year_full' => $series->yearFull(),
                'series.duration_label' => $series->durationLabel() ?? '',
                'series.finale_date_label' => $series->finaleDateLabel() ?? '',
                ...
                'series.next_episode_season' => '1',
                'series.next_episode_number' => '3',
                'series.next_episode_days_until' => '2',
